/**
 * This C program solves side effects that happen when using macros.
 *
...
void part1(int x) {
	...
	printf("Explanation: This error occurred because the paramater passed to isPositive is prefix incremented, so x is incremented twice, before the macro AND in the macro.\n\n\n"); // (3 points)
}

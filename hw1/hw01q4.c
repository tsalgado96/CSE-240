/**
 * This C program answers wether certain errors are Syntactic, Semantic, or Contextual.
 *
...
int main(){
   ...
   printf("y is %d\n",y); 
	...
	printf("Error Type: Semantic \n\n");
     ...
     printf("The code will still compile since 100 is a character in the ASCII table but it is not what we meant to print. \n\n");
	// Problem 4: (2 points)
